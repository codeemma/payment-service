...
public class CentralizedExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({PaymentValidationException.class, CancellationException.class})
    public ResponseEntity<Object> handlePaymentValidationException(Exception ex) {
